    ...
    private suspend fun promptUserToSelectEntityAndGetIndex(
        ...
        if (collectionsToCheck.size == 1) {
            ...
            if (options.size > 25) {
                ...
                interactionContextBase.interactionReplyManager.reply(
                    embed = Embed(
                ...
                while (stayInLoop) {
                    ...
                    interactionContextBase.interactionReplyManager.setReplyCallback(event)
                    ...
                    if (event is ButtonInteractionEvent) {
                        if (event.componentId == cancelButton.id) {
                            ...
                            interactionContextBase.interactionReplyManager.deferReply()
                            ...
                            interactionContextBase.interactionReplyManager.editComponents(
                                listOf(
                                    ActionRow.of(menu),
